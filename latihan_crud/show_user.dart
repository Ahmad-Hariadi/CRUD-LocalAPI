...
import 'package:flutter_coding_class/material/latihan_crud/add_user_form.dart';
import 'package:flutter_coding_class/material/latihan_crud/update_user_form.dart';
import 'package:flutter_coding_class/material/latihan_crud/user_model.dart';
            ...
            if (snapshot.hasData) {
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  if (snapshot.data?[index].gender == 'Wanita') {
                    avacol = Colors.pinkAccent;
                  } else {
